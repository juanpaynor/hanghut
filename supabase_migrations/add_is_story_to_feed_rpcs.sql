-- ============================================================
-- Add is_story and story location fields to feed RPCs
-- Both get_philippines_feed and get_following_feed need is_story
-- to properly route story post taps to the story viewer
-- ============================================================

-- 1. Update get_following_feed to include is_story and story location fields
...
-- 2. Update get_philippines_feed to include is_story and story location fields
