...
SELECT
    ...
    -- Subtitle: We'll fetch last message content in app or use a subquery if performance allows
    -- For view simplicity, we'll send a placeholder or metadata
    'Direct Message' AS subtitle, 
